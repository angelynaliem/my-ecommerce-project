...
//     })> */}
      ...
      <div className="relative">
        <SearchBox
          ...
          classNames={{
            input:
              "h-full w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset2 disabled:cursor-not-allowed disabled:opacity-50",
            submitIcon: "hidden",
            form: "relative mb-4",
            resetIcon: "hidden",
          }}
        ...
        <AnimatePresence>
          {active && (
            ...
            >
              <Hits hitComponent={Hit} className="rounded-md"></Hits>
            </MCard>
          )}
        </AnimatePresence>
      </div>
